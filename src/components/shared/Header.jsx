                    ...
                    <div className="flex items-center justify-between space-x-4">
                        ...
                        className="cursor-pointer transition-transform duration-300 ease-in-out transform hover:scale-110">
                            <div className="relative w-8 h-8 sm:w-9 sm:h-9">
                                ...
                                {/* Moon Icon (Dark Mode) */}
                                <svg
                                    className={`absolute transition-all duration-500 ease-in-out fill-current text-yellow-500 transform ${theme === 'lightHasan' ? 'opacity-100 rotate-0 scale-100' : 'opacity-0 rotate-180 scale-0'}`}
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24"
                                    >
